...
// glfw: initialize and configure
    ...
    GLFWwindow* window = glfwCreateWindow(mode->width, mode->height, "Minecraft in C++ using OpenGL", glfwGetPrimaryMonitor(), NULL);
	...
	// skybox shader
    Shader skybox_shader("assets/shaders/skybox_vert.glsl", "assets/shaders/skybox_frag.glsl");
	// skybox vertices
